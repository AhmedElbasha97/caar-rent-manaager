...
class CarRequestListScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder(
      ...
      builder: (CarRequestListController controller) =>  AnnotatedRegion<SystemUiOverlayStyle>(
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  controller.isLoading?const Expanded(child: Loader()):controller.carData?.isEmpty??true?
                  SizedBox(
